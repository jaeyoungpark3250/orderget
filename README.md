...
- order
```
 http :8088/orders id="id" productId="productId" productName="productName" 
```
- inventory
```
...
- delivery
```
 http :8088/deliveries id="id" orderId="orderId" productId="productId" productName="productName" 
```
